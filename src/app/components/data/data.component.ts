...
export class DataComponent {
  ...
  constructor() {
    ...
    this.forma = new FormGroup({
      ...
      pasatiempos: new FormArray([new FormControl('Comer', Validators.required)]),
  ...
  noApellido(control: AbstractControl): any {
  ...
  noIgual = (control: AbstractControl): any => {
  ...
  existeUsuario(control: AbstractControl): Promise<any> | Observable<any> {
    const promesa = new Promise((resolve, _reject) => {
      setTimeout(() => {
